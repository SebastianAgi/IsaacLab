...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    """Configuration for the lift scene with a robot and n objects.
...
#     object_pose = mdp.UniformAreaCommandCfg(
#         asset_name="robot",
#         body_name=MISSING,  # will be set by agent env cfg
#         resampling_time_range=(5.0, 5.0),
#         debug_vis=True,
#         ranges=mdp.UniformAreaCommandCfg.Ranges(
...
@configclass
class pushManyEnvCfg(ManagerBasedRLEnvCfg):
