...
class FrankaGran2D3DOFAttract(DirectRLEnv):
    ...
    def _compute_rewards(
        ...
        normalized_d = torch.where(d <= 0.1, normalized_d * 2, normalized_d)
        ...
        dist_reward = dist_reward / (2 * self.cfg.num_grans)  # Normalize by number of objects
        ...
        print(
              ...
              f"\ndirection_penalty_sum: {direction_penalty_scale * direction_penalty_norm[0]}"
