...
# class FrankaSlideEnvCfg(DirectRLEnvCfg):
#     """Configuration class for the FrankaSlideEnv environment."""
...
#         ),
#         init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -0.6, 0.3), rot=(1.0, 0.0, 0.0, 0.0)),
#     )
...
#             visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.0, 0.5, 0.5), metallic=0.1),
#             rigid_props=sim_utils.RigidBodyPropertiesCfg(
