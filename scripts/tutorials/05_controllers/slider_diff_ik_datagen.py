...
class SliderSceneCfg(InteractiveSceneCfg):
    ...
    table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.0, -0.6, 0.3), rot=(0.7071068, 0, 0, 0.7071068)),
    )
...
def main():
    ...
    # Design scene
    scene_cfg = SliderSceneCfg(num_envs=args_cli.num_envs, env_spacing=2.0)
